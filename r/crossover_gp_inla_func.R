...
ppc_ars <- function(dat, samp) {
  ...
  list(mean = ppc_stat(y, yrep),
       ...
       # ll checks
       zeros_ll = ppc_stat_grouped(y, yrep, ll_i, stat = function(y) mean(y == 0)),
       ones_ll = ppc_stat_grouped(y, yrep, ll_i, stat = function(y) mean(y == 1)),
       twos_ll = ppc_stat_grouped(y, yrep, ll_i, stat = function(y) mean(y == 2)),
       threes_ll = ppc_stat_grouped(y, yrep, ll_i, stat = function(y) mean(y == 3)),
       fours_ll = ppc_stat_grouped(y, yrep, ll_i, stat = function(y) mean(y == 4)),
       fives_ll = ppc_stat_grouped(y, yrep, ll_i, stat = function(y) mean(y == 5)),
       sixes_ll = ppc_stat_grouped(y, yrep, ll_i, stat = function(y) mean(y == 6)),
       sevens_ll = ppc_stat_grouped(y, yrep, ll_i, stat = function(y) mean(y == 7)),
       eights_ll = ppc_stat_grouped(y, yrep, ll_i, stat = function(y) mean(y == 8)),
       sd_ll = ppc_stat_grouped(y, yrep, ll_i, stat = "sd"),
       disp_ll = ppc_stat_grouped(y, yrep, ll_i, stat = stat_disp),
       # ye checks
       zeros_ye = ppc_stat_grouped(y, yrep, ye_i, stat = function(y) mean(y == 0)),
       ones_ye = ppc_stat_grouped(y, yrep, ye_i, stat = function(y) mean(y == 1)),
       twos_ye = ppc_stat_grouped(y, yrep, ye_i, stat = function(y) mean(y == 2)),
       threes_ye = ppc_stat_grouped(y, yrep, ye_i, stat = function(y) mean(y == 3)),
       fours_ye = ppc_stat_grouped(y, yrep, ye_i, stat = function(y) mean(y == 4)),
       fives_ye = ppc_stat_grouped(y, yrep, ye_i, stat = function(y) mean(y == 5)),
       sixes_ye = ppc_stat_grouped(y, yrep, ye_i, stat = function(y) mean(y == 6)),
       sevens_ye = ppc_stat_grouped(y, yrep, ye_i, stat = function(y) mean(y == 7)),
       eights_ye = ppc_stat_grouped(y, yrep, ye_i, stat = function(y) mean(y == 8)),
       sd_ye = ppc_stat_grouped(y, yrep, ye_i, stat = "sd"),
       disp_ye = ppc_stat_grouped(y, yrep, ye_i, stat = stat_disp),
